...
import Primos from "./prova/primos";
//import { Validity } from "./validade";

console.log("Códigos feitos pelos alunos Diogo Nery de Abreu e Mauro Henrique Gebara Kachutski");

/*
//data de validade
let teste1 = new Validity(10, 2, 2025);
console.log(teste1.validity()); 
let teste2 = new Validity(9, 2, 2026);
